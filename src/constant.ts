...
const SERVER_PORT = IS_PRODUCTION ? '' : 4000;

const DB_PORT = IS_PRODUCTION ? '' : 5432;
const DB_HOST = IS_PRODUCTION ? '' : '127.0.0.1';
const DB_USER = 'chaekbada';
const DB_PASSWORD = '1234';
const DB_NAME = 'chaekbada';

const SENDER_MAIL = 'rezzo@dkuh.co.kr';
const FRONT_END_URL = IS_PRODUCTION ? '' : 'http://localhost:3000';
